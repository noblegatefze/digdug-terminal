    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          <img
            src="/maintenance/terminal-banner.png"
            alt="DIGDUG Terminal"
            style={{
              width: "100%",
              height: "180px",
        ...
        <div style={{ padding: "18px 18px 16px 18px" }}>
          ...
          <div style={{ marginTop: "14px", fontSize: "12px", color: "rgba(255,255,255,0.50)" }}>
            We’re tightening security, reducing DB load, and preparing the next drop.
          </div>
        </div>
      </div>
    </main>
...
export function TerminalMaintenance() {
  return (
    <Shell
      title="DIGDUG Terminal is under maintenance"
      subtitle="We’re optimizing the network and hardening stability. Please check back soon."
    />
  );
}
